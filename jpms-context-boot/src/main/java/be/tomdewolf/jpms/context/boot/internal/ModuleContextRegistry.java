package be.tomdewolf.jpms.context.boot.internal;
...
import be.tomdewolf.jpms.context.boot.api.ModuleContext;
...
public class ModuleContextRegistry {
	...
	private static AnnotationConfigApplicationContext prepareApplicationContextFor(Module module) {
		...
		context.registerBean(be.tomdewolf.jpms.context.boot.internal.ModuleServiceReferenceAnnotationPostProcessor.class);
